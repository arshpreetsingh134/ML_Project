...
%  We will implement Collaborative Filtering Cost 
%  Regularization Function by adding the cost of
...
%  part of the code will also allow the reader to put in his own ratings for the
